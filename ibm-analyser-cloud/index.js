...
app.get("/", function(req, res) {
    res.status(200).send("Welcome to RESTFUL Server");
});
...
app.get("/visualrecognition/", function(req, res) {
    ...
    /*var images_file = fs.createReadStream('./images/hello1.png');
...
app.get("/helloworld", function(req, res) {
    ...
    const options = {
        ...
        dest: './images/hello.png' // Save to /path/to/dest/image.png
    }
...
app.get("/readProfile/:tid/:mid/:iid", function(req, res) {
    ...
    function seventh(callback) {
        ...
        function apicall(item, cb) {
                ...
                if (h == "Watson") {
                    ...
                    var images_file = fs.createReadStream("./images/hello" + j + ".png");
    ...
    function sixth_pre(callback) {
        ...
        function apicall(item, cb) {
            ...
            const options = {
                url: u,
                dest: './images/hello' + j + '.png' // Save to /path/to/dest/image.png
            }
